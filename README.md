...
1. Sign up or log in
2. Navigate to [Seedream Images API](https://platform.acedata.cloud/documents/seedream-images)
...
Install the [Seedream MCP plugin](https://plugins.jetbrains.com/plugin/com.acedatacloud.mcp.seedream) from the JetBrains Marketplace, or configure manually:
