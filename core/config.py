"""Configuration management for MCP Seedream server."""
...
class Settings:
    ...
    request_timeout: float = field(
        default_factory=lambda: float(os.getenv("SEEDREAM_REQUEST_TIMEOUT", "1800"))
    )

    # Server Configuration
    server_name: str = field(default_factory=lambda: os.getenv("MCP_SERVER_NAME", "seedream"))
